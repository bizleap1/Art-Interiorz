export const contactData = {
  ...
  heading: {
    prefix: "Let's design something",
    emphasis: "extraordinary",
    suffix: ".",
  },
  intro:
    "Tell us about your space, your timeline and the life you'd like to live within it. We take on a limited number of projects each year.",
  infos: [
    {
      label: "Studio",
      value:
