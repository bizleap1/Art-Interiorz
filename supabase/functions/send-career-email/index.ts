...
serve(async (req) => {
  ...
  try {
    ...
    const smtpFromName = Deno.env.get("SMTP_FROM_NAME") || "ArtInteriorz HR";
    
    // Directing explicitly to the HR email provided by the user
    const hrEmail = "artinteriorz.hr@gmail.com";
    ...
    // 5. Create HTML Email Template tailored for Careers
    const htmlEmail = `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p class="intro">A new Career / Vendor application has been submitted from the ArtInteriorz website.</p>
            ...
            <h3 style="margin-top: 30px; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; color: #666;">Application Details</h3>
    ...
    await transporter.sendMail({
      ...
      to: hrEmail,
      subject: "New Career / Vendor Application - ArtInteriorz",
      html: htmlEmail,
    });
